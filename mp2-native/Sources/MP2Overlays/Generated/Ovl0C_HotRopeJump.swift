...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HotRopeJump
public final class Ovl0C_HotRopeJump: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x0C }
    public static var name: String { "HotRopeJump" }
