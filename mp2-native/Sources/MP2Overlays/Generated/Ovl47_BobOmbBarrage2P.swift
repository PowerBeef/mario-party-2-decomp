...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BobOmbBarrage2P
public final class Ovl47_BobOmbBarrage2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x47 }
    public static var name: String { "BobOmbBarrage2P" }
