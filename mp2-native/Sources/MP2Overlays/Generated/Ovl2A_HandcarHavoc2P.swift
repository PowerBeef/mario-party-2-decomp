...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HandcarHavoc2P
public final class Ovl2A_HandcarHavoc2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x2A }
    public static var name: String { "HandcarHavoc2P" }
