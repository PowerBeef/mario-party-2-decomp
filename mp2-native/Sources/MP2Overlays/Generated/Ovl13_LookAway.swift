...
/// Auto-generated minigame stub — port gameplay from asm/overlays/LookAway
public final class Ovl13_LookAway: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x13 }
    public static var name: String { "LookAway" }
