...
/// Auto-generated minigame stub — port gameplay from asm/overlays/RollOutTheBarrels2P
public final class Ovl37_RollOutTheBarrels2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x37 }
    public static var name: String { "RollOutTheBarrels2P" }
