...
/// Auto-generated minigame stub — port gameplay from asm/overlays/CoffinCongestion2P
public final class Ovl38_CoffinCongestion2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x38 }
    public static var name: String { "CoffinCongestion2P" }
