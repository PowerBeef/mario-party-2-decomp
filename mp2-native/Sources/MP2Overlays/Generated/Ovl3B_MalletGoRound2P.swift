...
/// Auto-generated minigame stub — port gameplay from asm/overlays/MalletGoRound2P
public final class Ovl3B_MalletGoRound2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x3B }
    public static var name: String { "MalletGoRound2P" }
