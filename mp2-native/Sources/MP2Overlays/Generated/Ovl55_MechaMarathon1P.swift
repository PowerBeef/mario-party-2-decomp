...
/// Auto-generated minigame stub — port gameplay from asm/overlays/MechaMarathon1P
public final class Ovl55_MechaMarathon1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x55 }
    public static var name: String { "MechaMarathon1P" }
