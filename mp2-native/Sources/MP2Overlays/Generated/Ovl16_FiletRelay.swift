...
/// Auto-generated minigame stub — port gameplay from asm/overlays/FiletRelay
public final class Ovl16_FiletRelay: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x16 }
    public static var name: String { "FiletRelay" }
