...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BalloonBurst
public final class Ovl1B_BalloonBurst: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x1B }
    public static var name: String { "BalloonBurst" }
