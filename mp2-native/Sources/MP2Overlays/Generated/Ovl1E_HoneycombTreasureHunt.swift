...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HoneycombTreasureHunt
public final class Ovl1E_HoneycombTreasureHunt: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x1E }
    public static var name: String { "HoneycombTreasureHunt" }
