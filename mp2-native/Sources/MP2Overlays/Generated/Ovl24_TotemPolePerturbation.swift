...
/// Auto-generated minigame stub — port gameplay from asm/overlays/TotemPolePerturbation
public final class Ovl24_TotemPolePerturbation: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x24 }
    public static var name: String { "TotemPolePerturbation" }
