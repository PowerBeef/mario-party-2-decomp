...
/// Auto-generated minigame stub — port gameplay from asm/overlays/SkyPilots2P
public final class Ovl2C_SkyPilots2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x2C }
    public static var name: String { "SkyPilots2P" }
