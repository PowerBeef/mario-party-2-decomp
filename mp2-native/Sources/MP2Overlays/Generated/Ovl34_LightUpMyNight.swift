...
/// Auto-generated minigame stub — port gameplay from asm/overlays/LightUpMyNight
public final class Ovl34_LightUpMyNight: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x34 }
    public static var name: String { "LightUpMyNight" }
