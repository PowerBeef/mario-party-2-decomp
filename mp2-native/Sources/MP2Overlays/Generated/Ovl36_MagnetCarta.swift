...
/// Auto-generated minigame stub — port gameplay from asm/overlays/MagnetCarta
public final class Ovl36_MagnetCarta: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x36 }
    public static var name: String { "MagnetCarta" }
