...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BowlOver2P
public final class Ovl43_BowlOver2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x43 }
    public static var name: String { "BowlOver2P" }
