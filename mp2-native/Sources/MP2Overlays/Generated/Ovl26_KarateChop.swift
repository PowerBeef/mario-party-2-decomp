...
/// Auto-generated minigame stub — port gameplay from asm/overlays/KarateChop
public final class Ovl26_KarateChop: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x26 }
    public static var name: String { "KarateChop" }
