...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BalloonBurst2P
public final class Ovl2B_BalloonBurst2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x2B }
    public static var name: String { "BalloonBurst2P" }
