...
/// Auto-generated minigame stub — port gameplay from asm/overlays/ShuffleAdventure1P
public final class Ovl5D_ShuffleAdventure1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x5D }
    public static var name: String { "ShuffleAdventure1P" }
