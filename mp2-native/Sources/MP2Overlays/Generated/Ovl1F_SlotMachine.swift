...
/// Auto-generated minigame stub — port gameplay from asm/overlays/SlotMachine
public final class Ovl1F_SlotMachine: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x1F }
    public static var name: String { "SlotMachine" }
