...
/// Auto-generated minigame stub — port gameplay from asm/overlays/ShockDropRoll
public final class Ovl14_ShockDropRoll: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x14 }
    public static var name: String { "ShockDropRoll" }
