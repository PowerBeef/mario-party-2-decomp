...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BalloonBurst1P
public final class Ovl50_BalloonBurst1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x50 }
    public static var name: String { "BalloonBurst1P" }
