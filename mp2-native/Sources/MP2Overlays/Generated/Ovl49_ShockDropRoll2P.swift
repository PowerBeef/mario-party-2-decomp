...
/// Auto-generated minigame stub — port gameplay from asm/overlays/ShockDropRoll2P
public final class Ovl49_ShockDropRoll2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x49 }
    public static var name: String { "ShockDropRoll2P" }
