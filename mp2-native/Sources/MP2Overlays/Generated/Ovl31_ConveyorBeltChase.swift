...
/// Auto-generated minigame stub — port gameplay from asm/overlays/ConveyorBeltChase
public final class Ovl31_ConveyorBeltChase: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x31 }
    public static var name: String { "ConveyorBeltChase" }
