...
/// Auto-generated minigame stub — port gameplay from asm/overlays/ToadtressScramble2P
public final class Ovl4D_ToadtressScramble2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x4D }
    public static var name: String { "ToadtressScramble2P" }
