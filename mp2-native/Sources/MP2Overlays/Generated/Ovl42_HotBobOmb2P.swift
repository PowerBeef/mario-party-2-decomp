...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HotBobOmb2P
public final class Ovl42_HotBobOmb2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x42 }
    public static var name: String { "HotBobOmb2P" }
