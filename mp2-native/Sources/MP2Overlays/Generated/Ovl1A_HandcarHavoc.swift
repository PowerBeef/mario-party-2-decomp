...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HandcarHavoc
public final class Ovl1A_HandcarHavoc: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x1A }
    public static var name: String { "HandcarHavoc" }
