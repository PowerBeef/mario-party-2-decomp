...
/// Auto-generated minigame stub — port gameplay from asm/overlays/SpeedHikers1P
public final class Ovl52_SpeedHikers1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x52 }
    public static var name: String { "SpeedHikers1P" }
