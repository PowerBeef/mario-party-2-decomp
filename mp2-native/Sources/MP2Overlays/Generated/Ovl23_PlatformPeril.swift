...
/// Auto-generated minigame stub — port gameplay from asm/overlays/PlatformPeril
public final class Ovl23_PlatformPeril: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x23 }
    public static var name: String { "PlatformPeril" }
