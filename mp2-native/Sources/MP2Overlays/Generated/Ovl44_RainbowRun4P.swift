...
/// Auto-generated minigame stub — port gameplay from asm/overlays/RainbowRun4P
public final class Ovl44_RainbowRun4P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x44 }
    public static var name: String { "RainbowRun4P" }
