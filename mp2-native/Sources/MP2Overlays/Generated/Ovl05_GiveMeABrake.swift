...
/// Auto-generated minigame stub — port gameplay from asm/overlays/GiveMeABrake
public final class Ovl05_GiveMeABrake: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x05 }
    public static var name: String { "GiveMeABrake" }
