...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HammerSlammer2P
public final class Ovl39_HammerSlammer2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x39 }
    public static var name: String { "HammerSlammer2P" }
