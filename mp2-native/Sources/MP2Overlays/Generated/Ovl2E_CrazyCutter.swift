...
/// Auto-generated minigame stub — port gameplay from asm/overlays/CrazyCutter
public final class Ovl2E_CrazyCutter: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x2E }
    public static var name: String { "CrazyCutter" }
