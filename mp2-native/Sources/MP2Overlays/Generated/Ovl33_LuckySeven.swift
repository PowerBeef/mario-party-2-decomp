...
/// Auto-generated minigame stub — port gameplay from asm/overlays/LuckySeven
public final class Ovl33_LuckySeven: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x33 }
    public static var name: String { "LuckySeven" }
