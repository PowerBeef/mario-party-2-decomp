...
/// Auto-generated minigame stub — port gameplay from asm/overlays/GiveMeABrake2P
public final class Ovl3A_GiveMeABrake2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x3A }
    public static var name: String { "GiveMeABrake2P" }
