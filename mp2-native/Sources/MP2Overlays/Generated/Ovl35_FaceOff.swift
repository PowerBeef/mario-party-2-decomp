...
/// Auto-generated minigame stub — port gameplay from asm/overlays/FaceOff
public final class Ovl35_FaceOff: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x35 }
    public static var name: String { "FaceOff" }
