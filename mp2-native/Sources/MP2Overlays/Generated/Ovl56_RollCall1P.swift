...
/// Auto-generated minigame stub — port gameplay from asm/overlays/RollCall1P
public final class Ovl56_RollCall1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x56 }
    public static var name: String { "RollCall1P" }
