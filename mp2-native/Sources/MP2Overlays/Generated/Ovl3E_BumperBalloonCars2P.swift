...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BumperBalloonCars2P
public final class Ovl3E_BumperBalloonCars2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x3E }
    public static var name: String { "BumperBalloonCars2P" }
