...
/// Auto-generated minigame stub — port gameplay from asm/overlays/LightsOut
public final class Ovl15_LightsOut: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x15 }
    public static var name: String { "LightsOut" }
