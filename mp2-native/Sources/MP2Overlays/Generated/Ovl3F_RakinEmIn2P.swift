...
/// Auto-generated minigame stub — port gameplay from asm/overlays/RakinEmIn2P
public final class Ovl3F_RakinEmIn2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x3F }
    public static var name: String { "RakinEmIn2P" }
