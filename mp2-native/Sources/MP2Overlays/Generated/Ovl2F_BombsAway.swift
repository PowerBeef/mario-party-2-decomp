...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BombsAway
public final class Ovl2F_BombsAway: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x2F }
    public static var name: String { "BombsAway" }
