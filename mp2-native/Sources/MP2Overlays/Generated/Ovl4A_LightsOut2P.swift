...
/// Auto-generated minigame stub — port gameplay from asm/overlays/LightsOut2P
public final class Ovl4A_LightsOut2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x4A }
    public static var name: String { "LightsOut2P" }
