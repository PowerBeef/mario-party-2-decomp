...
/// Auto-generated minigame stub — port gameplay from asm/overlays/CoffinCongestion
public final class Ovl03_CoffinCongestion: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x03 }
    public static var name: String { "CoffinCongestion" }
