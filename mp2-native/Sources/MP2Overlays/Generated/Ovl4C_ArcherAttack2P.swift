...
/// Auto-generated minigame stub — port gameplay from asm/overlays/ArcherAttack2P
public final class Ovl4C_ArcherAttack2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x4C }
    public static var name: String { "ArcherAttack2P" }
