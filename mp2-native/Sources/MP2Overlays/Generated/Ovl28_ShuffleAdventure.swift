...
/// Auto-generated minigame stub — port gameplay from asm/overlays/ShuffleAdventure
public final class Ovl28_ShuffleAdventure: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x28 }
    public static var name: String { "ShuffleAdventure" }
