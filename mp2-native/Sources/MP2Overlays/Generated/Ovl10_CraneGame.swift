...
/// Auto-generated minigame stub — port gameplay from asm/overlays/CraneGame
public final class Ovl10_CraneGame: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x10 }
    public static var name: String { "CraneGame" }
