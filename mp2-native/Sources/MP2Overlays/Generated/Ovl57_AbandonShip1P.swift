...
/// Auto-generated minigame stub — port gameplay from asm/overlays/AbandonShip1P
public final class Ovl57_AbandonShip1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x57 }
    public static var name: String { "AbandonShip1P" }
