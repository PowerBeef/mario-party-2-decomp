...
/// Auto-generated minigame stub — port gameplay from asm/overlays/ToadtressScramble
public final class Ovl18_ToadtressScramble: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x18 }
    public static var name: String { "ToadtressScramble" }
