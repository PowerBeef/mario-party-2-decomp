...
/// Auto-generated minigame stub — port gameplay from asm/overlays/GrabBag
public final class Ovl07_GrabBag: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x07 }
    public static var name: String { "GrabBag" }
