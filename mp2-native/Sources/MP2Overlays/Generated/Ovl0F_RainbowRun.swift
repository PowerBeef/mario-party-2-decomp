...
/// Auto-generated minigame stub — port gameplay from asm/overlays/RainbowRun
public final class Ovl0F_RainbowRun: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x0F }
    public static var name: String { "RainbowRun" }
