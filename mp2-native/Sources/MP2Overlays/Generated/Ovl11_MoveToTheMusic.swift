...
/// Auto-generated minigame stub — port gameplay from asm/overlays/MoveToTheMusic
public final class Ovl11_MoveToTheMusic: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x11 }
    public static var name: String { "MoveToTheMusic" }
