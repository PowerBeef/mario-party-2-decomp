...
/// Auto-generated minigame stub — port gameplay from asm/overlays/TorpedoTargets
public final class Ovl32_TorpedoTargets: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x32 }
    public static var name: String { "TorpedoTargets" }
