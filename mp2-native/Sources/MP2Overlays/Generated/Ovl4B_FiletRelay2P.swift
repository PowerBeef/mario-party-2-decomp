...
/// Auto-generated minigame stub — port gameplay from asm/overlays/FiletRelay2P
public final class Ovl4B_FiletRelay2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x4B }
    public static var name: String { "FiletRelay2P" }
