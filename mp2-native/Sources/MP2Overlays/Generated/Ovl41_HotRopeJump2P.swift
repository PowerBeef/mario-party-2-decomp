...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HotRopeJump2P
public final class Ovl41_HotRopeJump2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x41 }
    public static var name: String { "HotRopeJump2P" }
