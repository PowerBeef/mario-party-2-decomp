...
/// Auto-generated minigame stub — port gameplay from asm/overlays/CraneGame2P
public final class Ovl45_CraneGame2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x45 }
    public static var name: String { "CraneGame2P" }
