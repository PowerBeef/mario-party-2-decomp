...
/// Auto-generated minigame stub — port gameplay from asm/overlays/LookAway2P
public final class Ovl48_LookAway2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x48 }
    public static var name: String { "LookAway2P" }
