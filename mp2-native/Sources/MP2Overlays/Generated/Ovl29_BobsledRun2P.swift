...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BobsledRun2P
public final class Ovl29_BobsledRun2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x29 }
    public static var name: String { "BobsledRun2P" }
