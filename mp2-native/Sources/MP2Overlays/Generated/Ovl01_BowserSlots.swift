...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BowserSlots
public final class Ovl01_BowserSlots: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x01 }
    public static var name: String { "BowserSlots" }
