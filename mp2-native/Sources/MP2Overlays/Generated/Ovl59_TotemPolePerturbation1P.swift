...
/// Auto-generated minigame stub — port gameplay from asm/overlays/TotemPolePerturbation1P
public final class Ovl59_TotemPolePerturbation1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x59 }
    public static var name: String { "TotemPolePerturbation1P" }
