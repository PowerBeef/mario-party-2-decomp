...
/// Auto-generated minigame stub — port gameplay from asm/overlays/SkyPilots1P
public final class Ovl51_SkyPilots1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x51 }
    public static var name: String { "SkyPilots1P" }
