...
/// Auto-generated minigame stub — port gameplay from asm/overlays/KarateChop1P
public final class Ovl5B_KarateChop1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x5B }
    public static var name: String { "KarateChop1P" }
