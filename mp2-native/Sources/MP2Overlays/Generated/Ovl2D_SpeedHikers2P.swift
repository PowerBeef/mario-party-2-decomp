...
/// Auto-generated minigame stub — port gameplay from asm/overlays/SpeedHikers2P
public final class Ovl2D_SpeedHikers2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x2D }
    public static var name: String { "SpeedHikers2P" }
