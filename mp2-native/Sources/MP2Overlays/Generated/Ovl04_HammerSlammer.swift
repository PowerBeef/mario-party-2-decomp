...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HammerSlammer
public final class Ovl04_HammerSlammer: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x04 }
    public static var name: String { "HammerSlammer" }
