...
/// Auto-generated minigame stub — port gameplay from asm/overlays/DayAtTheRaces2P
public final class Ovl40_DayAtTheRaces2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x40 }
    public static var name: String { "DayAtTheRaces2P" }
