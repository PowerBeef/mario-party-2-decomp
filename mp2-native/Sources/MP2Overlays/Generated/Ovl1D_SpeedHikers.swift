...
/// Auto-generated minigame stub — port gameplay from asm/overlays/SpeedHikers
public final class Ovl1D_SpeedHikers: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x1D }
    public static var name: String { "SpeedHikers" }
