...
/// Auto-generated minigame stub — port gameplay from asm/overlays/MalletGoRound
public final class Ovl06_MalletGoRound: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x06 }
    public static var name: String { "MalletGoRound" }
