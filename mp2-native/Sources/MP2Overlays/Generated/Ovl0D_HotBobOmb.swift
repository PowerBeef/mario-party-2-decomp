...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HotBobOmb
public final class Ovl0D_HotBobOmb: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x0D }
    public static var name: String { "HotBobOmb" }
