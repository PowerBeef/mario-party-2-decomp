...
/// Auto-generated minigame stub — port gameplay from asm/overlays/GrabBag2P
public final class Ovl3C_GrabBag2P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x3C }
    public static var name: String { "GrabBag2P" }
