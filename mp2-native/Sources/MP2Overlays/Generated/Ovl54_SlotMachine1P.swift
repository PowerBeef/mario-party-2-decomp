...
/// Auto-generated minigame stub — port gameplay from asm/overlays/SlotMachine1P
public final class Ovl54_SlotMachine1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x54 }
    public static var name: String { "SlotMachine1P" }
