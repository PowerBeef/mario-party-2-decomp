...
/// Auto-generated minigame stub — port gameplay from asm/overlays/HoneycombTreasureHunt1P
public final class Ovl53_HoneycombTreasureHunt1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x53 }
    public static var name: String { "HoneycombTreasureHunt1P" }
