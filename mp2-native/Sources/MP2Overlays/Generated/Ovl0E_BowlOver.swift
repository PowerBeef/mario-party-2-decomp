...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BowlOver
public final class Ovl0E_BowlOver: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x0E }
    public static var name: String { "BowlOver" }
