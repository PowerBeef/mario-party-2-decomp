...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BumperBalloonCars
public final class Ovl09_BumperBalloonCars: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x09 }
    public static var name: String { "BumperBalloonCars" }
