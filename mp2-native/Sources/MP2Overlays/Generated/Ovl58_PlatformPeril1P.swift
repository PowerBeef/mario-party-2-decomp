...
/// Auto-generated minigame stub — port gameplay from asm/overlays/PlatformPeril1P
public final class Ovl58_PlatformPeril1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x58 }
    public static var name: String { "PlatformPeril1P" }
