...
/// Auto-generated minigame stub — port gameplay from asm/overlays/StackingStored
public final class Ovl27_StackingStored: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x27 }
    public static var name: String { "StackingStored" }
