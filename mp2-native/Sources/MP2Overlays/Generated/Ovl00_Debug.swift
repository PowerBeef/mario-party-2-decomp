...
/// Auto-generated minigame stub — port gameplay from asm/overlays/Debug
public final class Ovl00_Debug: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x00 }
    public static var name: String { "Debug" }
