...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BobsledRun
public final class Ovl19_BobsledRun: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x19 }
    public static var name: String { "BobsledRun" }
