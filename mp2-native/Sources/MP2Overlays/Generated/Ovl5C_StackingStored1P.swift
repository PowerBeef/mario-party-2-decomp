...
/// Auto-generated minigame stub — port gameplay from asm/overlays/StackingStored1P
public final class Ovl5C_StackingStored1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x5C }
    public static var name: String { "StackingStored1P" }
