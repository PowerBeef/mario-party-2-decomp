...
/// Auto-generated minigame stub — port gameplay from asm/overlays/LavaTileIsle
public final class Ovl08_LavaTileIsle: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x08 }
    public static var name: String { "LavaTileIsle" }
