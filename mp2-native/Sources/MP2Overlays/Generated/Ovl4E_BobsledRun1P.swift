...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BobsledRun1P
public final class Ovl4E_BobsledRun1P: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x4E }
    public static var name: String { "BobsledRun1P" }
