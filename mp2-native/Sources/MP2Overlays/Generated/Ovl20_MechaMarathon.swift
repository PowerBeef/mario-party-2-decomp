...
/// Auto-generated minigame stub — port gameplay from asm/overlays/MechaMarathon
public final class Ovl20_MechaMarathon: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x20 }
    public static var name: String { "MechaMarathon" }
