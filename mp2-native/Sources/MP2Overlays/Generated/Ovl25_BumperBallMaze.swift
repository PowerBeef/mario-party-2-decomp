...
/// Auto-generated minigame stub — port gameplay from asm/overlays/BumperBallMaze
public final class Ovl25_BumperBallMaze: MinigameOverlay, OverlayModule, @unchecked Sendable {
    public static var overlayID: UInt8 { 0x25 }
    public static var name: String { "BumperBallMaze" }
